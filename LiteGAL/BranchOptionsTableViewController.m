//
//  BranchPopoverTableViewController.m
//  LiteGAL
//
...
@property (weak, nonatomic) NSArray *preOptions;

@end

@implementation BranchOptionsTableViewController
